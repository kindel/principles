...
`data/index.json` is the manifest. `data/<company>/<slug>.json` is one principle.
...
at their own pace. `version` in the manifest is 3: version 2 had a kebab-case
`id` that was unique only within a company.
